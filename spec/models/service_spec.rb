...
RSpec.describe Service, type: :model do
  describe "validations" do
    it "is valid with valid attributes" do
      ...
      service = Service.new(name: "Example Service", icon: "example.png", author: author)
      expect(service).to be_valid
    end

    it "is invalid without a name" do
      author = User.create(name: "John Doe")
      service = Service.new(name: nil, icon: "example.png", author: author)
      service.valid?
    ...
    it "is invalid without an icon" do
      author = User.create(name: "John Doe")
      service = Service.new(name: "Example Service", icon: nil, author: author)
      service.valid?
